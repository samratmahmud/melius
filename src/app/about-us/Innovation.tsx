...
const InnovationData = [
   {
      title: "Innovation",
      describetion:
         "We embrace and drive change through continuous innovation.",
   },
   {
      title: "Collaboration",
      describetion:
         "Success is a collective effort, and we thrive on collaboration.",
   },
   {
      title: "Customer-Centric",
      describetion:
         "Your success is our success, and we prioritize your unique needs.",
   },
   {
      title: "Excellence",
      describetion:
               ...
               <div>
                  <h2 className="text-12xl font-semibold font-tt-hoves capitalize mb-5">
                     ...
                     <span className="text-primary-500">
                        empower organizations to unleash the full potential of
                        their processes
                     </span>
                  </h2>
                  <p className="text-2xl font-futura-lt mb-10">
                     Whether you're a startup aiming for efficiency or an
                     established enterprise seeking to redefine your operations,
                     melius digital is here to guide you on your journey.
                  </p>
